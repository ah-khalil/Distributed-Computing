    ...
    try{
        if(this.readyState == '4'){
            if(this.status == '200'){
                ...
                console.log("Total: " + total_ab_scores);
            ...
            if(this.readyState == '4'){
                if(this.status == '200'){
                    try{
                        ...
                        console.log(racial_bonus_arr);
                        console.log(racial_bonus_p_elem_arr);
...
function submit(type){
    ...
    try{
        ...
        post_charac_xmlreq.onreadystatechange = function(){
            console.log("My skin is smothering me, mirrors start to whisper, shadows start to sing");
            if(this.readyState == '4'){
