...
namespace DnDAssignment.Controllers
{
    ...
    public class CharacterController : ApiController
    {
        ...
        public void create_xml(int id)
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    file_path = xml_name + "_" + id.ToString() + "_" + rand_num + ".xml";
        ...
        /*
         * Purpose: checks to see if the given name string is unique in the database
         * Params: name - string
         * Return: true or false depending on whether or not the name is unique in the database
         */
        private static bool check_name(string name)
        {
            ...
            try
            {
                ...
                using (SqliteConnection db_conn = new SqliteConnection(WebApiConfig.DB_CONN_STR))
                {
                    ...
                    /*Query to determine how many characters in the database with the supplied name*/
                    ...
                    //Execute the command and return a single value; the number of characters with the same name
            ...
            //Should not be getting more than one
            return (row_count >= 1);
        }
    }
}